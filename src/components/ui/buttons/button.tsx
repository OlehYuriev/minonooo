...
export function Button({
  ...
  const variants: Record<typeof variant, string> = {
    primary:
      " hover:text-white  hover:bg-[var(--foreground)]  border-[#cecece]",
    secondary:
      "bg-[var(--foreground)] text-white  hover:bg-transparent hover:text-[var(--foreground)] border-[var(--foreground)] hover:border-[#cecece]",
  };
  return (
    <>
      <button
